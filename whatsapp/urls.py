...
urlpatterns = [
    ...
    path('mensagem/<int:pk>/editar/', edit_message, name='edit_message'),
    path('mensagem/<int:pk>/deletar/', delete_message, name='delete_message'),
    ...
    path('conversa/<int:pk>/arquivar/', archive_conversation, name='archive_conversation'),
