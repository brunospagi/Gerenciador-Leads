...
urlpatterns = [
    ...
    path('facetec/session-token/', views.facetec_session_token_proxy, name='facetec_session_token_proxy'),
    path('facetec/liveness-3d/', views.facetec_liveness_proxy, name='facetec_liveness_proxy'),
