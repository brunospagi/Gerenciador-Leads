...
urlpatterns = [
    ...
    path('pendencias/modal/', views.pendencias_admin_modal_api, name='pendencias_modal_api'),
    path('pendencias/modal/ponto/<int:pk>/acao/', views.pendencia_ponto_acao_modal_api, name='pendencia_ponto_acao_modal_api'),
