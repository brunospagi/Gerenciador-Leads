...
urlpatterns = [
    ...
    path('notificacoes/dropdown/', notificacoes_dropdown, name='notificacoes_dropdown'),
    path('notificacoes/<int:notificacao_id>/marcar-lida/', marcar_lida_notificacao, name='marcar_lida_notificacao'),
