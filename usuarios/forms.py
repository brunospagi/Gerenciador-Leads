...
class ProfileAvatarForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = ['avatar', 'notificacao_whatsapp']
        widgets = {
            'avatar': forms.ClearableFileInput(attrs={'class': 'form-control'}),
            'notificacao_whatsapp': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
        }
        labels = {
            'notificacao_whatsapp': 'Receber notificações via WhatsApp',
        }
