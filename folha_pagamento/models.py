...
class FolhaPagamento(models.Model):
    ...
    def calcular_folha(self):
        ...
        # 2. Comissões (Vendas Aprovadas no mês da folha)
        ...
        self.total_descontos = parcelas.aggregate(Sum('valor'))['valor__sum'] or Decimal(0)
    ...
    def fechar(self):
        self.calcular_folha()
        # Marca parcelas como processadas
